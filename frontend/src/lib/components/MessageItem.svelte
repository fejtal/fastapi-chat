...
<!-- Messenger-style layout: 50% width, aligned left/right -->
<div class="flex w-full mb-4 {isOwnMessage ? 'justify-end' : 'justify-start'}">
	<div class="max-w-[50%] bg-card border rounded-lg shadow-sm hover:shadow-md transition-shadow {isOwnMessage ? 'bg-primary/10' : ''}">
		<div class="p-4">
